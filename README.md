...
<body>
    ...
    <section class="content">
        <p>Всем привет! Мы — будущая многомиллиардная компания MAG Industries, которая будет заниматься производством часов и различных электронных устройств.</p>
        <p>Мы прекрасно понимаем, что создать компанию с нуля крайне сложно, поэтому начинаем с небольших электронных устройств и разработки наручных часов. Они будут постепенно перерастать в серьезные проекты, приносящие незабываемые эмоции от пользования наших устройств.</p>
    ...
    <script>
        ...
        const clockData = {
            ...
            "Clock-5 Pro Max": {
                ...
                features: [
                    "Уменьшенный корпус",
                    "Сенсорный интерфейс + таже операционная сисьема что и у pro",
                    "WiFi 5.0",
                    "Датчики: пульс, SpO₂, акселерометр",
